...
/*   Updated: 2025/04/15 11:51:46 by scarlos-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			execute_commands(t_CommandData *data, char ***envp,
					t_var **vars);
char			*find_command_path(char *command, char *const envp[]);
bool			handle_and_continue_if_var_assignment(char *input,
					t_var **vars);
...
void			fill_updated_envp(char **envp, char **new_envp, char *new_entry,
					int replace_index);
char			**copy_envp_with_update(char **envp, char *new_entry,
					int replace_index);
int				execute_builtin(int *i, char ***envp, t_var **vars,
					t_CommandData *data);
int				check_builtin(char *command);
